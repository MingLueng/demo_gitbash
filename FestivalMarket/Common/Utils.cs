...
namespace FestivalMarket.Common
{
    public static class Utils
    {
        ...
        public static string cutStringDescription(string description) {
            int maxLength = 300;
            ...
            { 
                string cutDescription = description.Substring(0, maxLength); 
                int lastSpaceIndex = cutDescription.LastIndexOf(' '); 
                if (lastSpaceIndex != -1) 
                { 
                    cutDescription = cutDescription.Substring(0, lastSpaceIndex);
                } 
